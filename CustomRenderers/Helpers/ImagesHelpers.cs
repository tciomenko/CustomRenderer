...
using System.Linq;
namespace CustomRenderers.Helpers
{
    public static class ImagesHelper
    {
        ...
        public static ImageCaruselModel GetRandomMonkey()
        {
        ...
        public static ObservableCollection<Grouping<string, ImageCaruselModel>> ImagesGrouped { get; set; }

        public static ObservableCollection<ImageCaruselModel> Images { get; set; }

        static ImagesHelper()
        {
            random = new Random();
            Images = new ObservableCollection<ImageCaruselModel>();
            Images.Add(new ImageCaruselModel
            {
                Name = "Baboon",
            ...
            var sorted = from image in Images
                         orderby image.Name
                                      group image by image.NameSort into imageGroup
                                       select new Grouping<string, ImageCaruselModel>(imageGroup.Key, imageGroup);

            ImagesGrouped = new ObservableCollection<Grouping<string, ImageCaruselModel>>(sorted);
